...
module.exports = function addBuiltInCommands(commands) {
  commands
    ...
    .option('stats', {
      default: false,
      describe: 'generates webpack stats. Use https://webpack.github.io/analyse/ to analyze them',
      type: 'boolean'
    })
    .before((context, args) => {
  ...
  commands
    ...
    .option('happy', {
      type: 'boolean',
      default: false,
      describe: 'attempts to speed up you build with happypack (multithreaded compilation)'
    })
